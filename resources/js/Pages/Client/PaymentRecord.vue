  ...
  <app-layout>
    ...
    <div class="py-2">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg" v-if="PaymentRecord.data">
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="row in townships.data " v-bind:key="row.id">
                ...
                <td class="px-6 py-3 whitespace-nowrap"><a>{{ row.ftth_id }}</a> </td>
                    ...
                    <div class="">
                      <div class="mb-4">
                        ...
                        <input type="text"
                          ...
                          id="city" placeholder="Enter City" v-model="form.city">
...
export default {
  ...
  setup(props) {
    ...
    function submit() {
      if (!editMode.value) {
        form._method = 'POST';
        router.post('/PaymentRecord', form, {
          preserveState: true,
          onSuccess: (page) => {
            closeModal()
            resetForm()
        ...
        router.post('/PaymentRecord/' + form.id, form, {
          onSuccess: (page) => {
            closeModal()
            resetForm()
            Toast.fire(
    ...
    function deleteRow(data) {
      ...
      data._method = 'DELETE';
      router.post('/PaymentRecord/' + data.id, data)
      closeModal()
      resetForm()
    }
    function openModal() {
    ...
    const searchTsp = () => {
      ...
      router.get('/PaymentRecord/', { township: search.value }, { preserveState: true })
    }
