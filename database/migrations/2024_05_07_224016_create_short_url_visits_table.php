...
class CreateShortUrlVisitsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('short_url_visits', function (Blueprint $table) {
            ...
            $table->timestamp('visited_at')->useCurrent()->useCurrentOnUpdate();
            $table->timestamps();
            
            $table->foreign('short_url_id', 'short_url_visits_short_url_id_foreign')->references('id')->on('short_urls')->onDelete('cascade');
        });
    }
